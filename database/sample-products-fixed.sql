...
(
  ...
  '{"sk": "Učiaca Veža", "en": "Learning Tower", "de": "Lernturm", "fr": "Tour apprentissage"}',
  '{"sk": "Montessori veža pre nezávislé učenie v kuchyni. Bezpečná platforma pre deti od 12 mesiacov.", "en": "Montessori tower for independent learning in the kitchen. Safe platform for children from 12 months.", "de": "Montessori-Turm für selbstständiges Lernen in der Küche. Sichere Plattform für Kinder ab 12 Monaten.", "fr": "Tour Montessori pour apprentissage indépendant dans la cuisine. Plateforme sûre pour les enfants à partir de 12 mois."}',
  'learning-tower',
  159.99,
  179.99,
  'LT-001',
...
-- Children Chair (Creative Spaces category)
(
  '55555555-5555-5555-5555-555555555555',
  '{"sk": "Detská Stolička", "en": "Children Chair", "de": "Kinderstuhl", "fr": "Chaise pour enfants"}',
  '{"sk": "Ergonomická detská stolička v štýle Montessori. Podporuje správne držanie tela a nezávislé sedenie.", "en": "Ergonomic children chair in Montessori style. Supports proper posture and independent sitting.", "de": "Ergonomischer Kinderstuhl im Montessori-Stil. Unterstützt die richtige Körperhaltung und selbstständiges Sitzen.", "fr": "Chaise ergonomique pour enfants de style Montessori. Favorise une bonne posture et une assise indépendante."}',
  'childrens-chair',
  49.99,
  59.99,
  'CC-001',
